...
A_hor = 0.001495; % Area de los elementos horizontales en m^2
A_cord = 0.001895; % Area de los elementos cordones en m^2
A_diag = 0.002041; % Area de los elementos diagonales en m^2
...
% Con ciclo for con if ya que es un proceso repetitivo para grupos de
% elementos diferentes, me dio por eso esta comentado
% Matriz de rigidez ke en sistema local eq(17)
% for e = 1:nelem
%     if e == 1 || 2 || 3 || 4 || 5
%         A = A_hor;
%     elseif e == 6 || 15 || 16 || 17 || 20 || 25 || 26 || 27
%         A = A_cord;
%     elseif e == 7 || 8 || 9 || 10 || 11 || 12 || 13 || 14 || 18 || 19 || 21 || 22 || 23 || 24 
%         A = A_diag;
%     end
...
for e = 1:5
ke = [A_hor*E/L(e) 0 -A_hor*E/L(e) 0;0 0 0 0; -A_hor*E/L(e) 0 A_hor*E/L(e) 0; 0 0 0 0];
...
% Para cordones sueriores
for e = [6 15 16 17 20 25 26 27]
ke = [A_cord*E/L(e) 0 -A_cord*E/L(e) 0;0 0 0 0; -A_cord*E/L(e) 0 A_cord*E/L(e) 0; 0 0 0 0];
...
% para elementos diagonales interiores
for e = [7 8 9 10 11 12 13 14 18 19 21 22 23 24]
ke = [A_diag*E/L(e) 0 -A_diag*E/L(e) 0;0 0 0 0; -A_diag*E/L(e) 0 A_diag*E/L(e) 0; 0 0 0 0];
...
% Fuerzas axiales internas de cada elemento horizontal eq (30)
N = zeros(nelem,1);
for e = 1:5
    %  Extraemos los elementos del vector de desplazamientos
    De = D(LaG(e,:));
% Se calcula respuesta interna de cada elemento              
     N(e) = ((E*A_hor)/L(e))*[-eta(e) -mu(e) eta(e) mu(e)]*De;
% Se agrega la respuesta de cada elemento al vector de fuerzas internas
end

% para cordones superiores
for e = [6 15 16 17 20 25 26 27]
    %  Extraemos los elementos del vector de desplazamientos
    De = D(LaG(e,:));
% Se calcula respuesta interna de cada elemento              
     N(e) = ((E*A_cord)/L(e))*[-eta(e) -mu(e) eta(e) mu(e)]*De;
% Se agrega la respuesta de cada elemento al vector de fuerzas internas
end

% para diagonales internas
for e = [7 8 9 10 11 12 13 14 18 19 21 22 23 24]
    %  Extraemos los elementos del vector de desplazamientos
    De = D(LaG(e,:));
% Se calcula respuesta interna de cada elemento              
